...
public class OtherTicketAdapter extends FirestoreRecyclerAdapter<TicketModel, OtherTicketAdapter.TicketHolder> {


    public OtherTicketAdapter(@NonNull FirestoreRecyclerOptions<TicketModel> options) {
        super(options);
    }
       ...
       // Picasso.get().load(model.getImage1()).resize(80,80).into(holder.imageView);
        ...
        holder.layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(v.getContext(), OtherTicket.class);
